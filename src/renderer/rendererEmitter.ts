...
class Emitter implements GPMDP.IRendererEmitter {
  __defineGetter__: Function;
  __defineSetter__: Function;
  q: Function[];
  _internalEventWrappers: any;
  ready: boolean;
  ...
  constructor() {
    ...
    ipcRenderer.on('passthrough', (event, details) => {
      const view = <HTMLElement & { isLoading: Function, send: Function }>document.querySelector('webview');
      if (!view) {
