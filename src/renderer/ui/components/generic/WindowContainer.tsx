...
export default class WindowContainer extends React.Component<GPMDP.UI.ContainerProps & {
  confirmClose?: Function,
  isMainWindow?: boolean,
  title: string
}, GPMDP.UI.ThemedComponentProps & { nativeFrame?: boolean }> {
  static propTypes = {
  ...
  _themeUpdate = (event, theme: boolean) => {
    this.setState({ theme });
  }
