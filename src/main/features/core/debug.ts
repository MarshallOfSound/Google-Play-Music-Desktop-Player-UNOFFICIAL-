...
System Memory: ${os.totalmem()}
  ...
  addStringToZip('settings.json', JSON.stringify(_.assign({}, (<any>Settings).data, { lastFMKey: 'HIDDEN' }), null, 4));
