// // Type definitions for Electron 1.4.1
...
//   class NativeImage extends EventEmitter {
...
//   interface Shell extends EventEmitter {
...
//      */
//     writeShortcutLink(shortcutPath: String, operation: 'create' | 'update' | 'replace', options: WriteShortcutLinkOptions): Boolean;
//     /**
//      * Creates or updates a shortcut link at shortcutPath.
//      */
//     writeShortcutLink(shortcutPath: String, options: WriteShortcutLinkOptions): Boolean;
//   }
...
//      * net_error_list.
//      */
//     importCertificate(options: ImportCertificateOptions, callback: Function): void;
...
//      * badge. Returns true when the call succeeded, otherwise returns false. On macOS
//      * it shows on the dock icon. On Linux it only works for Unity launcher, Note:
//      * Unity launcher requires the exsistence of a .desktop file to work, for more
...
//      */
//     setUserTasks(tasks: any[]): Boolean;
//     /**
//      * Shows the dock icon.
//      */
//     show(): void;
...
//      */
//     capturePage(callback: Function): void;
//     /**
//      * Same as webContents.capturePage([rect, ]callback).
//      */
//     capturePage(rect: Rect, callback: Function): void;
//     /**
...
//      */
//     setBounds(options: BoundsOptions, animate?: Boolean): void;
//     /**
...
//      * x, y.
//      */
//     setContentBounds(options: ContentBoundsOptions, animate?: Boolean): void;
//     /**
...
//      */
//     setThumbnailClip(region: Region): void;
//     /**
...
//      */
//     static getDevToolsExtensions(): any;
...
//      */
//     showMessageBox(browserWindow: BrowserWindow, options: MessageBoxOptions, callback: Function): void;
//     /**
//      * Shows a message box, it will block the process until the message box is closed.
//      * It returns the index of the clicked button. If a callback is passed, the API
//      * call will be asynchronous and the result will be passed via callback(response).
//      */
//     showMessageBox(options: MessageBoxOptions, callback: Function): void;
//     /**
//      * Shows a message box, it will block the process until the message box is closed.
//      * It returns the index of the clicked button. If a callback is passed, the API
//      * call will be asynchronous and the result will be passed via callback(response).
...
//      */
//     showOpenDialog(browserWindow: BrowserWindow, options: OpenDialogOptions, callback?: Function): void;
//     /**
//      * On success this method returns an array of file paths chosen by the user,
//      * otherwise it returns undefined. The filters specifies an array of file types
//      * that can be displayed or selected when you want to limit the user to a specific
...
//      * 'openDirectory'] on these platforms, a directory selector will be shown.
//      */
//     showOpenDialog(options: OpenDialogOptions, callback?: Function): void;
//     /**
...
//      * callback(filename)
//      */
//     showSaveDialog(browserWindow: BrowserWindow, options: SaveDialogOptions, callback?: Function): void;
//     /**
//      * On success this method returns the path of the file chosen by the user,
//      * otherwise it returns undefined. The filters specifies an array of file types
//      * that can be displayed, see dialog.showOpenDialog for an example. If a callback
...
//      * callback(filename)
//      */
//     showSaveDialog(options: SaveDialogOptions, callback?: Function): void;
//   }
...
//      * scheme is successfully registered or completion(error) when failed. The
//      * uploadData is an array of data objects: To handle the request, the callback
//      * should be called with either the file's path or an object that has a path
//      * property, e.g. callback(filePath) or callback({path: filePath}). When callback
//      * is called with nothing, a number, or an object that has an error property, the
...
//     registerServiceWorkerSchemes(schemes: any[]): void;
//     /**
...
//      */
//     registerStandardSchemes(schemes: any[]): void;
//     /**
...
//      * objects.
//      */
//     get(filter: Filter, callback: Function): void;
//     /**
...
//      * complete.
//      */
//     set(details: Details, callback: Function): void;
//   }
...
//      */
//     onBeforeRedirect(filter: any, listener: Function): void;
//     /**
//      * The listener will be called with listener(details, callback) when a request is
//      * about to occur. The uploadData is an array of data objects: The callback has to
//      * be called with an response object:
//      */
//     onBeforeRequest(filter: any, listener: Function): void;
//     /**
...
//      */
//     onCompleted(filter: any, listener: Function): void;
//     /**
//      * The listener will be called with listener(details) when an error occurs.
//      */
//     onErrorOccurred(filter: any, listener: Function): void;
//     /**
...
//      */
//     onResponseStarted(filter: any, listener: Function): void;
//     /**
//      * The listener will be called with listener(details) just before a request is
//      * going to be sent to the server, modifications of previous onBeforeSendHeaders
//      * response are visible by the time this listener is fired.
//      */
//     onSendHeaders(filter: any, listener: Function): void;
//   }
...
//      */
//     getUserDefault(key: String, type: String): void;
//     /**
...
//                                        /**
//                                         * the file path of dropped files.
//                                         */
//                                        files: any[]) => void): this;
//     /**
...
//                                               callback: Function) => void): this;
//     /**
//      * The mediaFlags is an object with the following properties: The editFlags is an
//      * object with the following properties: Emitted when there is a new context menu
...
//                                            image: NativeImage,
//                                            /**
//                                             * (optional) - scaling factor for the custom cursor
//                                             */
//                                            scale: Number,
//                                            /**
...
//                                            size: Size,
//                                            /**
//                                             * (optional) - coordinates of the custom cursor's hotspot
//                                             */
...
//      * event.preventDefault() will prevent creating new windows.
//      */
...
//      * defaults to false.
//      */
//     beginFrameSubscription(onlyDirty: Boolean, callback: Function): void;
//     canGoBack(): Boolean;
...
//      */
//     executeJavaScript(code: String, userGesture?: Boolean, callback?: Function): void;
//     /**
...
//      */
//     printToPDF(options: PrintToPDFOptions, callback: Function): void;
//     /**
...
//      */
//     savePage(fullPath: String, saveType: 'HTMLOnly' | 'HTMLComplete' | 'MHTML', callback: Function): void;
//     /**
...
//      */
//     sendCommand(method: String, commandParams?: any, callback?: Function): void;
//   }
...
//      * calls callback(error, sources) when finished. sources is an array of Source
//      * objects, each Source represents a screen or an individual window that can be
//      * captured, and has the following properties:
//      */
//     getSources(options: SourcesOptions, callback: Function): void;
//   }
...
//     /**
//      * Should follow <code>window.location.origin</code>’s representation
//      * <code>scheme://host:port</code>.
//      */
//     origin: String;
//     /**
//      * The types of storages to clear, can contain: <code>appcache</code>,
//      * <code>cookies</code>, <code>filesystem</code>, <code>indexdb</code>, <code>local
//      * storage</code>, <code>shadercache</code>, <code>websql</code>,
//      * <code>serviceworkers</code>
//      */
//     storages: any[];
//     /**
//      * The types of quotas to clear, can contain: <code>temporary</code>,
//      * <code>persistent</code>, <code>syncable</code>.
//      */
//     quotas: any[];
//   }
...
//   interface ContentBoundsOptions {
//     x: Number;
//     y: Number;
//     width: Number;
//     height: Number;
...
//     srcURL: String;
//     /**
//      * Type of the node the context menu was invoked on. Can be <code>none</code>,
//      * <code>image</code>, <code>audio</code>, <code>video</code>, <code>canvas</code>,
//      * <code>file</code> or <code>plugin</code>.
//      */
//     mediaType: String;
//     /**
...
//      * Possible values are <code>none</code>, <code>plainText</code>,
//      * <code>password</code>, <code>other</code>.
//      */
//     inputFieldType: String;
//     /**
//      * Input source that invoked the context menu. Can be <code>none</code>,
//      * <code>mouse</code>, <code>keyboard</code>, <code>touch</code>,
//      * <code>touchMenu</code>.
//      */
//     menuSourceType: String;
//     /**
//      * The flags for the media element the context menu was invoked on. See more about
//      * this below.
//      */
//     mediaFlags: any;
//     /**
//      * These flags indicate whether the renderer believes it is able to perform the
//      * corresponding action. See more about this below.
//      */
//     editFlags: any;
//   }
...
//     rtf: String;
//     /**
//      * The title of the url at <code>text</code>.
//      */
//     bookmark: String;
//   }
...
//   interface Event {
//     /**
//      * (<strong>required</strong>) - The type of the event, can be
//      * <code>mouseDown</code>, <code>mouseUp</code>, <code>mouseEnter</code>,
//      * <code>mouseLeave</code>, <code>contextMenu</code>, <code>mouseWheel</code>,
//      * <code>mouseMove</code>, <code>keyDown</code>, <code>keyUp</code>,
//      * <code>char</code>.
//      */
//     type: String;
//     /**
//      * An array of modifiers of the event, can include <code>shift</code>,
//      * <code>control</code>, <code>alt</code>, <code>meta</code>,
//      * <code>isKeypad</code>, <code>isAutoRepeat</code>, <code>leftButtonDown</code>,
//      * <code>middleButtonDown</code>, <code>rightButtonDown</code>,
//      * <code>capsLock</code>, <code>numLock</code>, <code>left</code>,
//      * <code>right</code>.
//      */
//     modifiers: any[];
//   }
...
//   interface Filter {
//     /**
//      * (optional) - Retrieves cookies which are associated with <code>url</code>. Empty
//      * implies retrieving cookies of all urls.
//      */
//     url: String;
//     /**
...
//     domain: String;
//     /**
//      * (optional) - Retrieves cookies whose path matches <code>path</code>.
//      */
//     path: String;
//     /**
...
//     /**
//      * Whether to search forward or backward, defaults to <code>true</code>.
//      */
//     forward: Boolean;
//     /**
...
//     findNext: Boolean;
//     /**
//      * Whether search should be case-sensitive, defaults to <code>false</code>.
//      */
//     matchCase: Boolean;
//     /**
//      * Whether to look only at the start of words. defaults to <code>false</code>.
//      */
//     wordStart: Boolean;
//     /**
//      * When combined with <code>wordStart</code>, accepts a match in the middle of a
//      * word if the match begins with an uppercase letter followed by a lowercase or
//      * non-letter. Accepts several other intra-word matches, defaults to
//      * <code>false</code>.
//      */
...
//     /**
//      * Can be <code>"none"</code>, <code>"info"</code>, <code>"error"</code>,
//      * <code>"question"</code> or <code>"warning"</code>. On Windows, "question"
...
//      * Windows the index of "Cancel" button will always be used as
//      * <code>cancelId</code>, not matter whether it is already specified.
//      */
//     cancelId: Number;
//     /**
//      * On Windows Electron will try to figure out which one of the <code>buttons</code>
//      * are common buttons (like "Cancel" or "Yes"), and show the others as command
//      * links in the dialog. This can make the dialog appear in the style of modern
//      * Windows apps. If you don't like this behavior, you can set <code>noLink</code>
//      * to <code>true</code>.
//      */
//     noLink: Boolean;
//   }
...
//     /**
//      * Opens the devtools with specified dock state, can be <code>right</code>,
//      * <code>bottom</code>, <code>undocked</code>, <code>detach</code>. Defaults to
//      * last used dock state. In <code>undocked</code> mode it's possible to dock back.
//      * In <code>detach</code> mode it's not.
//      */
//     mode: String;
//   }
...
//     filters: any[];
//     /**
//      * Contains which features the dialog should use, can contain
//      * <code>openFile</code>, <code>openDirectory</code>, <code>multiSelections</code>,
//      * <code>createDirectory</code> and <code>showHiddenFiles</code>.
//      */
//     properties: any[];
//   }
...
//     /**
//      * <code>true</code> to bring the opened application to the foreground. The default
//      * is <code>true</code>.
//      */
//     activate: Boolean;
//   }
...
//     /**
//      * Specify the screen type to emulate (default: <code>desktop</code>) <ul>
//      * <li><code>desktop</code> String - Desktop screen type</li>
//      * <li><code>mobile</code> String - Mobile screen type</li> </ul>
//      */
//     screenPosition: String;
//     /**
//      * Set the emulated screen size (screenPosition == mobile) <ul>
//      * <li><code>width</code> Integer - Set the emulated screen width</li>
//      * <li><code>height</code> Integer - Set the emulated screen height</li> </ul>
//      */
//     screenSize: any;
//     /**
//      * Position the view on the screen (screenPosition == mobile) (default: <code>{x:
//      * 0, y: 0}</code>) <ul> <li><code>x</code> Integer - Set the x axis offset from
//      * top left corner</li> <li><code>y</code> Integer - Set the y axis offset from top
//      * left corner</li> </ul>
//      */
//     viewPosition: any;
//     /**
...
//     /**
//      * Set the emulated view size (empty means no override) <ul> <li><code>width</code>
//      * Integer - Set the emulated view width</li> <li><code>height</code> Integer - Set
//      * the emulated view height</li> </ul>
//      */
//     viewSize: any;
//     /**
//      * Whether emulated view should be scaled down if necessary to fit into available
//      * space (default: <code>false</code>)
//      */
//     fitToView: Boolean;
//     /**
//      * Offset of the emulated view inside available space (not in fit to view mode)
//      * (default: <code>{x: 0, y: 0}</code>) <ul> <li><code>x</code> Float - Set the x
//      * axis offset from top left corner</li> <li><code>y</code> Float - Set the y axis
//      * offset from top left corner</li> </ul>
//      */
//     offset: any;
//     /**
...
//     /**
//      * Don't ask user for print settings. Default is <code>false</code>.
//      */
//     silent: Boolean;
//     /**
...
//     marginsType: Number;
//     /**
//      * Specify page size of the generated PDF. Can be <code>A3</code>, <code>A4</code>,
//      * <code>A5</code>, <code>Legal</code>, <code>Letter</code>, <code>Tabloid</code>
//      * or an Object containing <code>height</code> and <code>width</code> in microns.
//      */
//     pageSize: String;
//     /**
...
//     /**
//      * <code>true</code> for landscape, <code>false</code> for portrait.
//      */
//     landscape: Boolean;
//   }
...
//     /**
//      * <em>Windows</em> - Mode for the progress bar (<code>none</code>,
//      * <code>normal</code>, <code>indeterminate</code>, <code>error</code>, or
//      * <code>paused</code>)
//      */
//     mode: String;
//   }
...
//   interface Settings {
//     /**
//      * <code>true</code> to open the app at login, <code>false</code> to remove the app
//      * as a login item. Defaults to <code>false</code>.
//      */
//     openAtLogin: Boolean;
//     /**
//      * <code>true</code> to open the app as hidden. Defaults to <code>false</code>. The
//      * user can edit this setting from the System Preferences so
//      * <code>app.getLoginItemStatus().wasOpenedAsHidden</code> should be checked when
//      * the app is opened to know the current value. This setting is only supported on
//      * macOS.
//      */
...
//     /**
//      * An array of String that lists the types of desktop sources to be captured,
//      * available types are <code>screen</code> and <code>window</code>.
//      */
//     types: any[];
//     /**
//      * (optional) - The suggested size that the media source thumbnail should be scaled
//      * to, defaults to <code>{width: 150, height: 150}</code>.
//      */
//     thumbnailSize: any;
//   }
...
//     submitURL: String;
//     /**
//      * (optional) - Defaults to <code>app.getName()</code>.
//      */
//     productName: String;
//     /**
//      * Send the crash report without user interaction. Default is <code>true</code>.
//      */
//     autoSubmit: Boolean;
//     /**
...
//   interface WriteShortcutLinkOptions {
//     /**
...
//     cwd: String;
//     /**
//      * (optional) - The arguments to be applied to <code>target</code> when launching
//      * from this shortcut. Default is empty.
//      */
//     args: String;
//     /**
...
//     description: String;
//     /**
//      * (optional) - The path to the icon, can be a DLL or EXE. <code>icon</code> and
//      * <code>iconIndex</code> have to be set together. Default is empty, which uses the
//      * target's icon.
//      */
//     icon: String;
//     /**
//      * (optional) - The resource ID of icon when <code>icon</code> is a DLL or EXE.
//      * Default is 0.
//      */
//     iconIndex: Number;
//     /**
